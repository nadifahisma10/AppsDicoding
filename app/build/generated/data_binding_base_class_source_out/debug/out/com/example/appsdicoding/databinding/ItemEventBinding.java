...
public final class ItemEventBinding implements ViewBinding {
  ...
  private ItemEventBinding(@NonNull LinearLayout rootView, @NonNull ImageView btnFavorite,
      @NonNull ImageView imageLogo, @NonNull TextView name, @NonNull TextView organizer,
  ...
  public static ItemEventBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemEventBinding((LinearLayout) rootView, btnFavorite, imageLogo, name, organizer,
          progressBar);
    }
